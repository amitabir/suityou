...
<script type="text/javascript" src="profile_validate.js"></script>
 <div class="content">
    ...
    <form id="update_form" action="update.php" method="post">
  		<div class="center">  			
        	<label for="email">Email</label><input type="email" name="email" value="<?php echo htmlentities($user->{'email'}, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $read_only;?>/><br />
            ...
            <label for="birth_date">Birth Date:</label><input type="date" name="birth_date" id="birth_date" <?php echo $read_only;?> /><br />
            <!--INSERT ISDESIGNER FURTHER LOGICS--><label for="is_designer">Designer:</label><input type="checkbox" name="is_designer" id="is_designer" value="0" <?php echo $read_only;?>/><br/>
            ...
            <label for="website_link">Web Site:<span class="small">(optional)</span></label><input type="url" name="website_link" id="website_link"  value="<?php echo htmlentities($user->{'website_link'}, ENT_QUOTES, 'UTF-8');?>" <?php echo $read_only;?>/><br />
